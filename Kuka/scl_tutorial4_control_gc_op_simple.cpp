...
int main(int argc, char** argv)
{
  ...
  const Eigen::Vector3d hpos(-0.24,0,0); //control position of off-set point wrt. hand
  Eigen::MatrixXd Jx;
  double zi = 0.8;
  double ti = 0;
  ...
  //const Vec3f offset(0,5,2.5); //control position of off-set of Kinect
