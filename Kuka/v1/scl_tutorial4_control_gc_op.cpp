...
#pragma omp parallel private(thread_id)
  {
	...
	float ball_pos_threshold = .1,radius=.025,rho=1,Cd=.2,mass=.0027,impact_time=(10000*dt),Delta_T=.0001;
	...
	while( iter<200000 && true == scl_chai_glut_interface::CChaiGlobals::getData()->chai_glut_running)
	  {
        ...
        ping_pong->setLocalPos(ball_pos_int(0), ball_pos_int(1), ball_pos_int(2));
