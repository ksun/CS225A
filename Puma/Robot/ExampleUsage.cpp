...
void pauseTillInPosition(RobotCom* myRobot, float q[], int qSize)
{
	float curJPos[NUM_JOINT_ANGLES];
	while(true)
	{
		bool inRange = true;
		myRobot->getStatus(GET_JPOS, curJPos);
		for(int i=0; i<NUM_JOINT_ANGLES; i++)
		{
			if(abs(curJPos[i] - q[i]) > 4)
				inRange = false;
		}
		if(inRange) return;
		Sleep(20);
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	pauseTillInPosition(myRobot, q, NUM_JOINT_ANGLES);
		...
		for (int i=0; i<numOfNotes; i++) {
			switch(noteList[i])
			{
				...
				case 400:
					...
					break;
				case 500:
					q = impactPositionsJPos[4];
					break;
				case 600:
					q = impactPositionsJPos[5];
					break;
				case 700:
					q = impactPositionsJPos[6];
					break;
				case 800:
					q = impactPositionsJPos[7];
					break;
				case 900:
					q = impactPositionsJPos[8];
					break;
				case 1000:
					q = impactPositionsJPos[9];
					break;
				case 1100:
					q = impactPositionsJPos[10];
					break;
				case 1200:
					q = impactPositionsJPos[11];
					break;
				default:
					q = temp_q;
					break;
			...
			pauseTillInPosition(myRobot, q, 6);
			//Sleep(500);
			...
			if(i < (numOfNotes-1))
			{
				switch(noteList[i+1])
				{
					...
					case 400:
						...
						break;
					case 500:
						q = preImpactPositionsJPos[4];
						break;
					case 600:
						q = preImpactPositionsJPos[5];
						break;
					case 700:
						q = preImpactPositionsJPos[6];
						break;
					case 800:
						q = preImpactPositionsJPos[7];
						break;
					case 900:
						q = preImpactPositionsJPos[8];
						break;
					case 1000:
						q = preImpactPositionsJPos[9];
						break;
					case 1100:
						q = preImpactPositionsJPos[10];
						break;
					case 1200:
						q = preImpactPositionsJPos[11];
						break;
					default:
						q = temp_q;
						break;
				}
				myRobot->control(JGOTO, q, NUM_JOINT_ANGLES);
			}
